<form action="<?php echo e(url('/user/ajax')); ?>" method="POST" id="form-tambah">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\laragon\www\PWL_2025\Minggu6\Jobsheet 6\resources\views/user/create_ajax.blade.php ENDPATH**/ ?>