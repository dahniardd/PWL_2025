...
<head>
    ...
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>"> <!-- Untuk mengirimkan token Laravel CSRF pada setiap request ajax-->
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.css')); ?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/dist/css/adminlte.min.css')); ?>">

    <?php echo $__env->yieldPushContent('css'); ?> <!-- Digunakan untuk memanggil custom css dari perintah push('css') pada masing-masing view -->
</head>
...
<!-- jquery-validation -->
<script src="<?php echo e(asset('adminlte/plugins/jquery-validation/jquery.validate.js')); ?>"></script>
...
<?php echo $__env->yieldPushContent('js'); ?> <!-- Digunakan untuk memanggil custom js dari perintah push('js') pada masing-masing view -->
</body>
</html><?php /**PATH C:\laragon\www\PWL_2025\Minggu6\Jobsheet 6\resources\views/layouts/template.blade.php ENDPATH**/ ?>