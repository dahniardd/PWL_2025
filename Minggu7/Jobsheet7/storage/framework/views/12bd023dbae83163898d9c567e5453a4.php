                ...
                <form action="<?php echo e(url('login')); ?>" method="POST" id="form-login">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-1">
                            ...
                            <a href="<?php echo e(url('/register')); ?>" class="btn btn-secondary btn-block">Register</a>
                        </div>
                    <!-- /.col -->
                    </div>
                </form>
...
</html><?php /**PATH C:\laragon\www\PWL_2025\Minggu7\Jobsheet7\resources\views/auth/login.blade.php ENDPATH**/ ?>